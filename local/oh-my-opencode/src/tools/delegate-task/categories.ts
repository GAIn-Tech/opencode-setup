...
export function resolveCategoryConfig(
  ...
  // Delegated category tasks should favor category routing/defaults, not parent UI model.
  // Model priority: user category override > category default > system default
