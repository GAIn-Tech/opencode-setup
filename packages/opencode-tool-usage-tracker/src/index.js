...
/**
 * Configure the tracker with an external MetaAwarenessTracker instance.
 * When used standalone, the no-op default is sufficient.
 * When used via opencode-learning-engine, the real MetaAwarenessTracker is injected.
 */
function configure({ tracker } = {}) {
