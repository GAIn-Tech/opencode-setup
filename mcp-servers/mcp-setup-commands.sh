...
echo "     Command: npx -y @ignidor/web-search-mcp"
echo "     Requires: Nothing"
echo ""
echo "  7. grep (local)"
...
echo ""
echo "  9. distill (local)"
echo "     Command: uvx --from git+https://github.com/gxuri/distill-mcp distill-mcp --mode mcp --transport stdio --lazy"
echo "     Requires: uv/uvx (pip install uv)"
echo ""
echo "=========================================="
